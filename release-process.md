...
Uploading to PyPI is done after the release has been uploaded to apache. Go to the <a href="https://pypi.python.org">PyPI website at https://pypi.python.org</a> and log in with the spark-upload account (see the PMC mailing list for account permissions).
