...
<a href="https://dist.apache.org/repos/dist/release/spark/spark-4.2.0-preview1">Spark 4.2.0-preview1 release</a>.
This preview is not a stable release in terms of either API or functionality, but it is meant to give the community early
access to try the code that will become Spark 4.2.0. If you would like to test the release,
please <a href="https://dist.apache.org/repos/dist/release/spark/spark-4.2.0-preview1">download</a> it, and send feedback using either
...
The documentation is available at the <a href="https://spark.apache.org/docs/4.2.0-preview1/">link</a>.
