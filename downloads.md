...
Note that Spark 3 is pre-built with Scala 2.12 in general and Spark 3.2+ provides additional pre-built distribution with Scala 2.13. Spark 4 is pre-built with Scala 2.13, and support for Scala 2.12 has been officially dropped.
