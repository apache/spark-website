...
<ul>
  <li><a href="{{site.url}}docs/latest/">Spark 1.3.1 (latest release)</a></li>
...
<ul>
  ...
  <li><a href="http://www.manning.com/bonaci/">Spark GraphX in Action</a>, by Michael Malak (Manning)</li>
