...
and another SparkDataFrame while preserving the duplicates. This is
equivalent to `INTERSECT ALL` in SQL. Also as standard in SQL, this
...
`insertInto()`, `intersect()`, `isLocal()`, `isStreaming()`, `join()`,
